...
def download_button(object_to_download, download_filename, button_text):
    ...
    try:
        ...
        # 需要指定encode和decode的编码，否则会乱码
        b64 = base64.b64encode(object_to_download.encode("utf_8_sig")).decode(encoding="utf_8_sig")
    except AttributeError as e:
        b64 = base64.b64encode(object_to_download).decode(encoding="utf_8_sig")
